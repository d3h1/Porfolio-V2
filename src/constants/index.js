...
//   We are doing our navbar links here
...
//   We are showing our services -- what we have years in
  const services = [
    {
...
//   What technologies we know -- might not need this down the line
  const technologies = [
    {
      name: "Python",
      icon: python,
...
//   Our experiences -- customize to your needs
  const experiences = [
    {
...
//   Export each of these constants through out the project
